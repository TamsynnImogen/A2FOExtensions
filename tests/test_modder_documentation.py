...
class ModderDocumentationTests(unittest.TestCase):
    ...
    def test_every_public_command_family_is_indexed(self) -> None:
        required_terms = (
            ...
            "usePrimaryTarget = 1", "usePrimaryTarget = 0",
            "infoSingleCaptainTextArea", "infoSingleRegistryTextArea",
            "captainNameColor", "shipRegistryColor",
            "weaponIconColor", "weaponIconLowColor",
            "weaponIconCriticalColor", "weaponIconDisabledColor",
            "weaponIconDestroyedColor",
            "passiveWeaponIconColor",
            ...
            "infoBuildName", "infoBuildClass",
            "directionalShieldColor", "directionalShieldValueDisplayMode",
            "directionalShieldValueColor", "directionalShieldValueLowColor",
            "directionalShieldValueCriticalColor",
            "`dsf`", "`dsb`", "`dsl`", "`dsr`",
            ...
            "shuttleCraftRechargeMode", "shuttleCraftDisplayMode",
            "shuttleCraftValueDisplayMode", "shuttleCraftLabel",
            "shuttleCraftTooltip", "shuttleCraftVerboseTooltip",
            "shuttleCraftIcon", "shuttleCraftIconPos",
            "photonTorpedoCost", "quantumTorpedoCost",
            "shuttleCraftCost", "shuttleCraftColor",
            "shuttleCraftLowColor", "shuttleCraftCriticalColor",
