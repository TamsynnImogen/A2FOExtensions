...
bool validate_armada_module(HMODULE module) {
    ...
    if (identity == a2fo::supported_armada::Identity::janb_20260905) {
        log_line(
            "ArmadaL.exe Jan_B September 2026 build accepted "
            "(supported on-disk code/read-only fingerprints matched)");
        return true;
    }
